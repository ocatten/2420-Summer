...
public class FacilityGenericTester {
	...
	@Test
 	...
 	@Test
 	public void testOrderedByDateCutoff() {
 		ArrayList<CurrentPatientGeneric<Integer>> actual = phase3Facility.getOrderedByDate(p3date1);
 		assertEquals(0, actual.size());
 	}
 	
	@Test
 	public void testOrderedByDate() {
 		ArrayList<CurrentPatientGeneric<Integer>> actual = phase3Facility.getOrderedByDate(p3date4);
 		assertEquals(actual.get(0).getLastVisit(), p3date3);
 		assertEquals(actual.get(1).getLastVisit(), p3date2);
 		assertEquals(actual.get(2).getLastVisit(), p3date1);
 	}
}