...
public class StudentBadHash {
	...
	/**
	 * This is an intentionally bad hashing function. It finds the length of the first and last name, combined
	 * with the uID (which will always be the same length) and returns that number as the hashCode. It will likely
	 * never change with the increasing capacity beyond a threshold
	 * 
	 * @return: The length of this.toString()
	 */
	public int hashCode() {
