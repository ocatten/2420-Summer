...
public class SpellChecker {
	...
	public List<String> spellCheck(File documentFile) {
		...
		//List of the words from the file
		List<String> wordsToCheck = readFromFile(documentFile);
		
		//List of misspelled words that is later returned
		List<String> misspelledWords = new ArrayList<String>();

		//Check each word from wordsToCheck for spelling
	...
	private void buildDictionary(List<String> words) {
		...
		//add each string as its own node to the binary search tree
		//(which acts as the dictionary)
	...
	/**
	 * @return: Binary search tree for dictionary
	 */
